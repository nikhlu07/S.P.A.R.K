  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)]">
      <div className="bg-gray-900/50 card-border-glow rounded-lg p-10 md:p-12 text-center animation-none">
        <h1 className="font-tech text-3xl md:text-4xl font-bold text-white text-glow">Join S.P.A.R.K.</h1>
        <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-400">Connect your wallet to create your profile and start your journey in the neural commerce matrix.</p>
        <div className="mt-8">
